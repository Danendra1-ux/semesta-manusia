...
export default function SJNPendaftarDetailPage({ params }) {
  ...
  // Helper untuk mendapatkan jawaban berdasarkan field_id
  ...
  const getFileForField = (field) => {
    return pendaftar?.registration_files?.find(f => f.field_key === field.id);
  };
  ...
  // Ambil struktur form pendaftaran berdasarkan funding type
  const fundingCode = pendaftar.program_funding_types?.code;
  const formSchema =
    fundingCode === "fully"
      ? program?.custom_registration_form_fully
      : fundingCode === "self"
        ? program?.custom_registration_form_self
        : program?.custom_registration_form;
        ...
        <div className={styles.profileCard}>
          ...
          <div className={styles.profileInfo}>
            ...
            <div className={styles.profileStatus}>
              <span className={`${styles.statusBadge} ${getTipeBadgeClass(pendaftar.program_funding_types?.label || "Fully Funded")}`}>
                {pendaftar.program_funding_types?.label || "Fully Funded"}
              </span>
            </div>
          </div>
        </div>
        ...
        <div className={styles.registrationCard}>
          ...
          <div className={styles.registrationGrid}>
            ...
            <div className={styles.registrationItem}>
              ...
              <span className={styles.registrationValue}>{program?.title || "Program SJN"}</span>
            </div>
            <div className={styles.registrationItem}>
